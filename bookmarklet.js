   ...
   console.log("BOOTED UP BABY");
    ...
    $('div').each( function() {
      if ( $(this).css('background-image').indexOf('.jpg') > 1 ) {
          ...
          if (urls.indexOf($(this).css('background-image').substr(4, ($(this).css('background-image').length-5))) === -1) {
            urls.push($(this).css('background-image').substr(4, ($(this).css('background-image').length-5)));
          }
